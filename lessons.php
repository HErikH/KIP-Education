...
if (!empty($smallVideos['name']) && isset($_POST['lesson_id'])) {
    ...
    if (is_array($smallVideos['name']) && !empty(array_filter($smallVideos['name']))) {
        ...
        foreach ($smallVideos['name'] as $key => $video) {
            ...
            if (move_uploaded_file($smallVideos['tmp_name'][$key], $videoPath)) {
...
<div class="content">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="add-lesson-btn" data-bs-toggle="modal" data-bs-target="#addLessonModal">+ Add Lesson</button>
                    <button class="btn-public" data-bs-toggle="modal" data-bs-target="#publicLessonModal">Public</button>
                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#updateUserLessonsModal">Update user_lessons</button>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo $lesson['image']; ?>" alt="Lesson Image" class="lesson-image"></td>
                                <td><?php echo $lesson['title']; ?></td>
                                <td><?php echo $lesson['tag']; ?></td>
                                <td>
    <!-- View button -->
    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#viewLessonModal<?php echo $lesson['id']; ?>">View</button>
    <!-- Edit button -->
    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editLessonModal<?php echo $lesson['id']; ?>">Edit</button>
    <!-- Delete button -->
    ...
    <!-- Manage button -->
    <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#manageLessonModal<?php echo $lesson['id']; ?>">Manage</button>
    <!-- Duplicate button -->
    <a href="duplicate_lesson.php?id=<?php echo $lesson['id']; ?>" class="btn btn-sm btn-secondary">Duplicate</a>
</td>

                            </tr>
                            
                            <!-- Update user_lessons Modal -->
<div class="modal fade" id="updateUserLessonsModal" tabindex="-1" aria-labelledby="updateUserLessonsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateUserLessonsModalLabel">Update user_lessons</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Do you want to update the user_lessons table with the latest changes?</p>
...
<div class="modal fade" id="viewLessonModal<?php echo $lesson['id']; ?>" tabindex="-1" aria-labelledby="viewLessonModalLabel<?php echo $lesson['id']; ?>" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <div>
                    <h5 class="modal-title" id="viewLessonModalLabel<?php echo $lesson['id']; ?>"><?php echo $lesson['title']; ?></h5>
                    <p class="modal-tag"><?php echo $lesson['tag']; ?></p>
                </div>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <div class="modal-video">
                    ...
                    <div class="video-container">
                        <video id="lessonVideo<?php echo $lesson['id']; ?>" controls controlslist="nodownload">
                            <source src="<?php echo $lesson['video']; ?>" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                    </div>
                    <?php endif; ?>
                    <button class="btn btn-secondary" onclick="restoreMainVideo('<?php echo $lesson['video']; ?>', 'lessonVideo<?php echo $lesson['id']; ?>')">Restore Main Video</button>
                </div>
...
<div class="modal-other-videos" style="display: flex; flex-wrap: wrap; gap: 10px;">
    <h6>Other Videos:</h6>
...
<div class="modal fade" id="editLessonModal<?php echo $lesson['id']; ?>" tabindex="-1" aria-labelledby="editLessonModalLabel<?php echo $lesson['id']; ?>" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editLessonModalLabel<?php echo $lesson['id']; ?>">Edit Lesson</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="editLessonForm<?php echo $lesson['id']; ?>" action="edit_lesson_handler.php" method="post" class="edit-form" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $lesson['id']; ?>">

                    <!-- Title Field -->
                    <div class="mb-3">
                        <label for="title<?php echo $lesson['id']; ?>" class="form-label">Title</label>
                        <input type="text" name="title" class="form-control" id="title<?php echo $lesson['id']; ?>" value="<?php echo $lesson['title']; ?>">
                    </div>

                    <!-- Tag Field -->
                    <div class="mb-3">
                        <label for="tag<?php echo $lesson['id']; ?>" class="form-label">Tag</label>
                        <input type="text" name="tag" class="form-control" id="tag<?php echo $lesson['id']; ?>" value="<?php echo $lesson['tag']; ?>">
                    </div>

                    <!-- Image Upload -->
                    <div class="mb-3">
                        <label for="image<?php echo $lesson['id']; ?>" class="form-label">Image</label>
                        <input type="file" name="image" class="form-control" id="image<?php echo $lesson['id']; ?>">
                    </div>

                    <!-- Main Video Upload -->
                    <div class="mb-3">
                        <label for="video<?php echo $lesson['id']; ?>" class="form-label">Main Video</label>
                        <input type="file" name="video" class="form-control" id="video<?php echo $lesson['id']; ?>" onchange="autoUploadVideo(this, '<?php echo $lesson['id']; ?>')">
                    </div>

                    <!-- Small Videos Upload -->
                    <div class="mb-3">
                        <label for="small_videos<?php echo $lesson['id']; ?>" class="form-label">Small Videos</label>
                        <input type="file" name="small_videos[]" class="form-control" id="small_videos<?php echo $lesson['id']; ?>" multiple>
                        <small class="text-muted">You can upload multiple small videos.</small>
                    </div>

                    <!-- Files Upload -->
                    <div class="mb-3">
                        <label for="files<?php echo $lesson['id']; ?>" class="form-label">Files</label>
                        <input type="file" name="files[]" class="form-control" id="files<?php echo $lesson['id']; ?>" multiple>
                    </div>

                    <!-- Progress Bar -->
                    <progress id="progressBar<?php echo $lesson['id']; ?>" value="0" max="100" style="width:100%;"></progress>
                    ...
                    <button type="submit" class="btn btn-success">Save changes</button>
                            ...
                            <div class="modal fade" id="manageLessonModal<?php echo $lesson['id']; ?>" tabindex="-1" aria-labelledby="manageLessonModalLabel<?php echo $lesson['id']; ?>" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="manageLessonModalLabel<?php echo $lesson['id']; ?>">Manage Lesson</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form action="activate_lesson.php" method="post">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="userIdInput<?php echo $lesson['id']; ?>" class="form-label">Enter User ID</label>
                                                            <input type="text" class="form-control" id="userIdInput<?php echo $lesson['id']; ?>" name="user_id" placeholder="Enter user ID">
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form action="make_public_lesson.php" method="post">
                                                        <input type="hidden" name="lesson_id" value="<?php echo $lesson['id']; ?>">
                                                        <div class="mb-3">
                                                            <label for="publicUserIdInput<?php echo $lesson['id']; ?>" class="form-label">Enter Public User ID</label>
                                                            <input type="text" class="form-control" id="publicUserIdInput<?php echo $lesson['id']; ?>" name="public_user_id" placeholder="Enter public user ID">
                                                        </div>
                                                        <button type="submit" class="btn btn-success">Add to Public</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-body">
                <form action="process_add_lesson.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="lessonImage" name="image" accept="image/*" required>
                    </div>
                    <div class="mb-3">
                        <label for="lessonVideo" class="form-label">Upload Video</label>
                        <input type="file" class="form-control" id="lessonVideo" name="video" accept="video/*" onchange="showProgressBar(this)">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="lessonFile1" name="file1" accept=".pdf,.pptx,.docx">
                        <input type="file" class="form-control mt-2" id="lessonFile2" name="file2" accept=".pdf,.pptx,.docx">
                        <input type="file" class="form-control mt-2" id="lessonFile3" name="file3" accept=".pdf,.pptx,.docx">
                        <input type="file" class="form-control mt-2" id="lessonFile4" name="file4" accept=".pdf,.pptx,.docx">
                    </div>
            ...
            <div class="modal-body">
                <form action="make_public_lesson.php" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="lessonId" name="lesson_id" placeholder="Enter Lesson ID">
                    </div>
                    <div class="mb-3">
