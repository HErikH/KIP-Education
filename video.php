...
@media (max-width: 768px) {
    ...
    .file-iframe {
        width: 100%; /* Full width iframe on smaller screens */
    }
}
...
.pagination-wrapper-top {
    ...
    align-items: center; /* Aligns buttons and fields vertically */
    gap: 20px; /* Spacing between input field and pagination */
    margin-top: 20px;
}
...
.video-grid {
    ...
    gap: 20px; /* Տարածություն վիդեոների միջև */
    padding: 0; /* Հեռացնում ենք padding-ը */
    margin: 0; /* Հեռացնում ենք margin-ը */
    list-style-type: none; /* Հեռացնում ենք կետերը */
}

.video-grid li {
    list-style-type: none; /* Հեռացնում ենք ցուցակի կետերը */
}

.small-video {
    width: 100%; /* Վիդեոները կտեղավորվեն 100% լայնությամբ իրենց բլոկի մեջ */
    height: auto; /* Բարձրությունը կհամապատասխանի լայնությանը */
}
...
.modal-body-overlay {
    position: absolute;
    bottom: 24px; /* Համոզվեք, որ overlay-ը տեղադրվում է մոդալի ներքևում */
    left: calc(50% - 100px); /* Տեղադրում ենք ձախ կողմ՝ կախված ընդհանուր լայնությունից */
    width: 90px; /* Կարգավորում ենք լայնությունը */
    height: 20px; /* Նվազեցնում ենք բարձրությունը */
    background-color: #444444; /* Թույլ մոխրագույն գույն՝ առանց թափանցիկության */
    z-index: 9999; /* Ամենաբարձր z-index, որպեսզի ծածկի մյուս տարրերը */
    border-top-right-radius: 0px; /* Տարրին ավելի գեղեցիկ տեսք տալու համար */
}

/* Մեդիա հարցումներ 991px-ից 769px էկրանների համար */
@media (max-width: 991px) and (min-width: 769px) {
    .modal-body-overlay {
        left: calc(50% - 120px); /* Տեղափոխում ենք ավելի արագ ձախ կողմ */
        width: 30px; /* Կարգավորում ենք լայնությունը 10px */
            bottom: 25px; /* Համոզվեք, որ overlay-ը տեղադրվում է մոդալի ներքևում */
...
@media (max-width: 768px) {
    .modal-body-overlay {
        left: calc(50% - 180px); /* Կարգավորում ենք ձախ դիրքը փոքր էկրանների համար */
        width: 0px; /* Չփոփոխվող լայնություն */
        bottom: 953px; /* Բարձրությունը մնում է նույնը */
    }
}
...
<div class="pagination-wrapper-top">
    ...
    <form method="GET" action="" class="search-by-id">
        <input type="number" name="post_id" id="post_id" placeholder="ID" min="1" max="64" class="form-control-lg" required>
