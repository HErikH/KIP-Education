...
<head>
    ...
    <style>
        ...
        .preview-container img {
            max-width: 150px; /* Փոքրացնում ենք նկարի չափը */
            max-height: 150px;
            margin-top: 10px;
        }
        .remove-preview {
...
<div class="container">
    ...
    <form action="edit_new_post.php?id=<?php echo $post_id; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <div id="previewContainer" class="preview-container" style="<?php echo ($post['image_url']) ? 'display:inline-block;' : 'display:none;'; ?>">
                <img id="imagePreview" src="<?php echo htmlspecialchars($post['image_url']); ?>" alt="Image Preview">
