...
<head>
    ...
    <style>
        ...
        @media (min-width: 1024px) {
            body {
                margin-top: 150px;
                /* Add 50px of space at the top for desktop screens */
            }
        }
        ...
        .program-container {
            ...
            padding: 0 10px;
            gap: 10px;
            /* Set gap between program boxes to 10px for desktop */
            flex-wrap: wrap;
            width: 80%;
        ...
        .program-box {
            ...
            width: 20%;
            /* Adjusted width to fit 5 boxes in a row */
            cursor: pointer;
            margin: 5px;
            /* Reduced margin to ensure 10px distance between boxes on desktop */
        }
        ...
        @media (max-width: 768px) {
            ...
            .program-box {
                ...
                margin-bottom: 10px;
                /* Add space between the boxes on mobile */
            }
        }
        ...
        .card-container {
            ...
            width: 100%;
            /* Card container width set to 90% */
            margin-left: auto;
            margin-right: auto;
            /* Center the container */
        }
        ...
        .card {
            ...
            border-radius: 15px;
            margin: 5px;
            /* Reduced margin for less space between cards */
            width: 18%;
            /* Adjusted width to fit 5 cards, accounting for the reduced margin */
        ...
        @media (max-width: 768px) {
            .card-container {
                ...
                align-items: center;
                width: 90%;
                /* Ensure the card container is 90% on mobile */
            }

            .card {
                width: 90%;
                /* Make the cards 90% of the width on mobile */
                margin: 10px 0;
        ...
        .payment-methods img {
            width: 60px;
            /* Փոխեք սա ըստ Ձեր ցանկության */
            height: auto;
            /* Կպահի պատկերի հարաբերակցությունը */
            margin-right: 10px;
            /* Տարածություն նկարների միջև */
        }
        ...
        .btn-confirm {
            ...
            /* Լավագույն padding */
            border-radius: 50px;
            /* Կլորացրած անկյուններ */
            font-size: 18px;
            /* Տեքստի չափ */
            font-weight: bold;
            /* Տեքստի հաստություն */
            text-transform: uppercase;
            /* Տեքստը մեծատառ դարձնել */
            border: none;
            /* Սահման չկա */
            ...
            /* Անիմացիա */
            cursor: pointer;
            /* Ցուցիչը դառնում է ձեռքի նշան */
            margin-top: 10px;
            width: 100%;
            /* Լայնությունը՝ ամբողջ դաշտի */
        }

        .btn-confirm:hover {
            background-color: #27ae60;
            /* Մուգ կանաչ երբ մկնիկով նշված է */
            transform: translateY(-2px);
            /* Մի փոքր բարձրացնում է կոճակը */
        }

        .btn-confirm:active {
            background-color: #1e8449;
            /* Շատ մուգ կանաչ սեղմման ժամանակ */
            transform: translateY(0);
            /* Վերադարձնում է իր տեղը */
        }

        @media (max-width: 768px) {
            .popup {
                flex-direction: column;
                /* Ուղղահայաց դառնալու համար */
                max-width: 100%;
                /* Լրիվ լայնություն փոքր էկրանների համար */
            }

            .popup-left {
                width: 100%;
                /* Հորիզոնական լայնությունը ամբողջ էկրանով */
                margin-bottom: 20px;
                /* Տարածություն */
            }
            ...
            .popup-right {
                ...
                display: flex;
                flex-direction: column;
                /* Դարձնում ենք ուղղահայաց */
            }

            .btn-confirm {
                order: -1;
                /* Կոճակը տեղափոխում է վերև */
                margin-bottom: 20px;
                /* Տարածություն ներքևում */
            }
        }
        ...
        .card2 {
            ...
            /* Reduced margin for less space between cards */
            width: 22%;
            /* Adjusted width to fit cards with a slightly larger width */
            box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.2);
            text-align: center;
            transition: transform 0.3s ease, box-shadow 0.3s ease;
            min-height: 350px;
...
?>
    ...
    <div class="card-container" id="k1-cards" style="display: none;">
        ...
        <div class="card">
            ...
            <ul style="list-style-type: none; padding-left: 0; text-align: left;"> <!-- Added left alignment -->
                ...
                <li style="margin-bottom: 5px; text-transform: capitalize;"><span
                        style="color: #f3ed17;">&#10003;</span>
                    <?= $line ?>
                </li>
                <?php endforeach; ?>
            </ul>
            ...
            <a href="#" class="buy-btn" data-title="<?= htmlspecialchars($product['title']) ?>"
    ...
    <section class="teacher-packages">
        <h2 class="teacher-packages-title">
            We offer <span class="highlight">annual teaching packages</span> to educational institutions for English
            language programs based on the theory of multiple intelligences
        </h2>

        <div id="teacher-cards" class="card-container"
            style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; padding-top: 20px;">
            <?php foreach ($products as $product): ?>
    ...
    <div class="popup-overlay" id="popupOverlay">
        <div class="popup">
            ...
            <div class="popup-left">
                ...
                <ul id="popup-info" style="list-style-type: none; padding-left: 0; text-align: left;"></ul>
                <!-- Information with checkmarks -->
            ...
            <div class="popup-right">
                <form id="buyProductForm">
                    ...
                    <p><strong>Full Name:</strong>
                        <?= htmlspecialchars($user_data['first_last_name']); ?>
                    </p>
                    <input type="hidden" name="first_last_name"
                        value="<?= htmlspecialchars($user_data['first_last_name']); ?>">
                    <?php else: ?>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="payment_method" id="balancePayment"
